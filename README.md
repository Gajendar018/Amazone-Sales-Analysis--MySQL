...
## 📌 Overview
This project analyzes Amazon product sales using MySQL to understand pricing trends, discount patterns, customer preferences, and product performance. The analysis helps identify what influences customer purchase decisions on e-commerce platforms.
...
👉 Full SQL queries are available in the attached PDF file.

## 🛠 SQL Features Used
- SELECT, WHERE  
- Text search using LIKE  
- Aggregations (AVG, COUNT)  
- Filtering on price, discount & ratings  
